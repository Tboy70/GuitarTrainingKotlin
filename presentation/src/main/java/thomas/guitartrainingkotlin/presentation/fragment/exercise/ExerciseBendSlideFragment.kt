...
@AndroidEntryPoint
class ExerciseBendSlideFragment : BaseExerciseFragment() {
    ...
    private fun initiateToolbar() {
        ...
        activity?.setSupportActionBar(
            fragment_exercise_bend_slide_toolbar,
    ...
    private fun initiateView() {
        ...
        setDurationUI(
            fragment_exercise_bend_slide_duration,
            fragment_exercise_bend_slide_duration_left
        )
