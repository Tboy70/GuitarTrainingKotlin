...
@AndroidEntryPoint
class ExerciseSpeedFragment : BaseExerciseFragment() {

    override fun getLayoutId(): Int = R.layout.fragment_exercise_speed

    private var navHost: View? = null

    private val exerciseSpeedViewModel by viewModels<ExerciseSpeedViewModel>()
    ...
    private fun initiateToolbar() {
        ...
        activity?.setSupportActionBar(
            fragment_exercise_speed_toolbar,
