...
class ExerciseSpeedFragment : BaseExerciseFragment<ExerciseSpeedViewModel>() {

    override val viewModelClass = ExerciseSpeedViewModel::class
    override fun getLayoutId(): Int = R.layout.fragment_exercise_speed
    ...
    private fun initiateToolbar() {
        ...
        activity?.setSupportActionBar(fragment_exercise_speed_toolbar, ActivityExtensions.DISPLAY_UP)
        fragment_exercise_speed_toolbar.title = nameProgram
    }
