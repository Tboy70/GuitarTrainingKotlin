...
class ExercisePalmMuteFragment : AbstractExerciseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setToolbar(R.string.toolbar_title_exercise_palm_mute)
    }

    private fun handleClickStartButton() {
        fragment_exercise_palm_mute_button_start_exercise.setOnClickListener {
            launchTimer(fragment_exercise_palm_mute_duration_left)
        }
    }

    private fun handleClickNextButton() {
        fragment_exercise_palm_mute_next_button.setOnClickListener {
            startNextExercise()
        }
    }
}